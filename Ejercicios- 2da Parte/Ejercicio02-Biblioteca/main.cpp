...
void cargarLibros() {
	...
	libros[8][0] = "Base de Datos"; libros[8][1] = "Base de Datos (2011)"; libros [8][2] = "Kenneth Rosen";
	...
	libros[16][0] = "Metodologias de desarrollo de software"; libros[16][1] = "Scrum & Extreme Programming (para programadores)"; libros[16][2] = "Bruce Eckel";
	libros[17][0] = "Metodologias de desarrollo de software"; libros[17][1] = "Scrum y XP desde las trincheras"; libros[17][2] = "Bruce Eckel";
	libros[18][0] = "Miscelaneos"; libros[18][1] = "97 cosas que todo programador deberia saber"; libros[18][2] = "Bruce Eckel";
	libros[19][0] = "Miscelaneos"; libros[19][1] = "Docker"; libros[19][2] = "Jesus Fuentes";
	libros[20][0] = "Miscelaneos"; libros[20][1] = "El camino a un mejor programador";libros [20][2] = "Jesus Fuentes";
	libros[21][0] = "Miscelaneos"; libros[21][1] = "Introduccion a Docker";libros [21][2] = "Jesus Fuentes";
	libros[22][0] = "Miscelaneos"; libros[22][1] = "Programacion de videojuegos SDL";libros [22][2] = "Rogelio Mata";
	libros[23][0] = "PHP"; libros[23][1] = "Manual de estudio introductorio al lenguaje PHP procedural"; libros [23][2] = "Francisco Montero";
	libros[24][0] = "PHP"; libros[24][1] = "PHP y Programacion orientada a objetos"; libros[24][2] = "Francisco Montero";
	libros[25][0] = "PHP"; libros[25][1] = "POO y MVC en PHP"; libros [25][2] = "Francisco Montero";
	libros[26][0] = "PHP"; libros[26][1] = "Silex, el manual oficial"; libros [26][2] = "Francisco Montero";
	libros[27][0] = "PHP"; libros[27][1] = "Symfony 1.4, la guia definitiva";  libros [27][2] = "Francisco Montero";
	libros[28][0] = "PHP"; libros[28][1] = "Symfony 2.4, el libro oficial"; libros [28][2] = "Francisco Montero";
	libros[29][0] = "Python"; libros[29][1] = "Aprenda a pensar como un programador (con Python)"; libros [29][2] = "Francisco Montero";
	libros[30][0] = "Python"; libros[30][1] = "Doma de Serpientes para Ninos: Aprendiendo a Programar con Python"; libros[30][2] = "Douglas Comer";
	libros[31][0] = "Python"; libros[31][1] = "Inmersion en Python";libros [31][2] = "Douglas Comer";
	libros[32][0] = "Python"; libros[32][1] = "Inmersion en Python 3"; libros [32][2] = "Douglas Comer";
	libros[33][0] = "Python"; libros[33][1] = "Introduccion a la programacion con Python";libros [33][2] = "Douglas Comer";
	libros[34][0] = "Python"; libros[34][1] = "Introduccion a Programando con Python"; libros [34][2] = "Douglas Comer";
	libros[35][0] = "Python"; libros[35][1] = "Python instantaneo (1999)";libros[35][2] = "Jose Eduardo";
	libros[36][0] = "Python"; libros[36][1] = "Python para ciencia e ingenieria"; libros [36][2] = "Jose Eduardo";
	libros[37][0] = "Python"; libros[37][1] = "Python para principiantes"; libros [37][2] = "Jose Eduardo";
	libros[38][0] = "Python"; libros[38][1] = "Python para todos"; libros[38][2] = "Jose Eduardo";
}
